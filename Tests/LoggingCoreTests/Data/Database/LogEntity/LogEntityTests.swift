...
struct LogEntityTests {
    @Test
    func debugDescriptionAll() throws {
        let entity = try logEntity(withNil: false)
        let expectedResult = """
    ...
    func debugDescriptionMinimal() throws {
        let entity = try logEntity(withNil: true)
        let expectedResult = """
    ...
    private func logEntity(withNil: Bool) throws -> LogEntity {
        try LogEntity(
    ...
    private func device(_ withNil: Bool) throws -> LogEntity.Device {
        try LogEntity.Device(
